export var headers = {
    ...
    "sale_out":[
        ...
        { field: "product_code", title: "产品编码", width: 80, sort: true,  align: "center" },
        { field: "inventory_code", title: "存货编码", width: 80, sort: true,  align: "center" },
        { field: "ac_set", title: "账套", width: 80, sort: true,  align: "center" },
        { field: "warehouse_code", title: "仓库编码", width: 80, sort: true,  align: "center" },
        { field: "warehouse_name", title: "仓库名称", width: 80, sort: true,  align: "center" },
        { field: "warehouse_out_code", title: "出库单号", width: 80, sort: true,  align: "center" },
        { field: "out_num", title: "数量", width: 80, sort: true,  align: "center" },
        { field: "out_date", title: "出库日期", width: 80, sort: true,  align: "center" },
        { field: "order_code", title: "来源订单号", width: 80, sort: true,  align: "center" },
        { field: "reviewed_by", title: "审核人", width: 80, sort: true,  align: "center" },
        { field: "audit_date", title: "审核时间", width: 80, sort: true,  align: "center" },
        { field: "out_type", title: "出库类型", width: 80, sort: true,  align: "center" },
        { fixed: "right", title: "操作",  align: "center", toolbar: "#barDemo", width: 180},
    ],
    "bom_sum":[
        { field: "id", title: "序号", width: 80, sort: true,  align: "center" },
